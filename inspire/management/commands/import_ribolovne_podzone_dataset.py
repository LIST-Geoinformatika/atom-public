...
class Command(BaseCommand):
    help = "Prepare RibolovnePodzone instances for DatasetServiceFeed"
    ...
    def handle(self, *args, **options):
        ...
        sql_query = "SELECT oznaka, geom FROM inspire_ribolovnapodzona"
        ...
        zip_filename = os.path.join(data_dir, "ribolovne-podzone.zip")
        ...
        dataset_service_feed = DatasetServiceFeed.objects.create(
            ...
            service_name="ribolovne-podzone",
            title="Ribolovne podzone",
            subtitle="Subtitle for ribolovne podzone",
            self_link=reverse("dataset-feed", args=["ribolovne-podzone"]),
