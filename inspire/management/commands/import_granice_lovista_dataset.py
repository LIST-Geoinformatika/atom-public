...
class Command(BaseCommand):
    help = "Prepare GraniceLovišta instances for DatasetServiceFeed"
    ...
    def handle(self, *args, **options):
        ...
        sql_query = "SELECT * FROM inspire_granicalovista"
        ...
        zip_filename = os.path.join(data_dir, "granice-lovista.zip")
        ...
        dataset_service_feed = DatasetServiceFeed.objects.create(
            ...
            service_name="granice-lovista",
            title="Granice državnih i privatnih lovišta",
            subtitle="Subtitle for ribolovne podzone",
            self_link=reverse("dataset-feed", args=["granice-lovista"]),
