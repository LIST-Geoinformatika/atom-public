...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        sql_query = "SELECT * FROM inspire_odsjeksumasumoposjednika"
        ...
        zip_filename = os.path.join(data_dir, "odsjek-suma.zip")
        ...
        dataset_service_feed = DatasetServiceFeed.objects.create(
            ...
            service_name="odsjek-suma",
            title="Odsjek šuma šumoposjednika",
            subtitle="Subtitle",
            self_link=reverse("dataset-feed", args=["odsjek-suma"]),
